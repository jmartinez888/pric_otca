...
class indexController extends foroController {
	...
	public function agenda() {
		...
		if (Cookie::lenguaje() == "en") {
			$id_lenguaje = Cookie::lenguaje()."-ca";
		} else {
			$id_lenguaje = Cookie::lenguaje();
		}
		$this->_view->setJs(array('agenda', array(BASE_URL . 'public/js/fullcalendar/moment.min.js'), array(BASE_URL . 'public/js/fullcalendar/fullcalendar.min.js'), array(BASE_URL . 'public/js/fullcalendar/locale/'.$id_lenguaje.'.js')));
