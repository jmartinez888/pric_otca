<div  class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
    ...
    <div  class="col-md-10 col-xs-12 col-sm-8 col-lg-10" style="margin-top: 10px;">
        <div class="col col-xs-11 col-sm-11 col-md-11 col-lg-11">
            <h2 class="titulo">{$lenguaje.str_consultas}</h2>
        </div>
        ...
        <div class="col col-xs-1 col-sm-1 col-md-1 col-lg-1   pull-right text-right titulo">
            ...
            <ul class="dropdown-menu" style="min-width: 200px;">
                ...
                <li><a href="{$_layoutParams.root}foro/admin/form/new/query" class="opciones_foro" style="cursor: pointer;">{$lenguaje.foro_discusion_nueva_consulta}<i class="i_opciones_foro glyphicon glyphicon-plus pull-right"></i></a></li>
                {/if}
