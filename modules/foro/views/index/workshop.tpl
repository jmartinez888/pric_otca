<div  class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
    ...
    <div  class="col-md-10 col-xs-12 col-sm-8 col-lg-10" style="margin-top: 10px;">
     <div class="col col-xs-11 col-sm-11 col-md-11 col-lg-11">
               <h2 class="titulo">{$lenguaje.str_workshop}</h2>
        </div>   
          <div class="col col-xs-1 col-sm-1 col-md-1 col-lg-1   pull-right text-right titulo">
            ...
            <ul class="dropdown-menu" style="min-width: 200px;">
                   {if $_acl->permiso("agregar_workshop")}
                <li><a href="{$_layoutParams.root}/foro/admin/form/new/workshop" class="opciones_foro" style="cursor: pointer;">{$lenguaje.foro_discusion_nuevo_workshop}<i class="i_opciones_foro glyphicon glyphicon-plus pull-right"></i></a></li>
                {/if}
        ...
        <div class="col col-md-offset-6 col-lg-offset-6 col-md-6 col-xs-12 col-sm-12 col-lg-6">
                <div class="input-group">
                    <input type ="text" class="form-control"  data-toggle="tooltip" data-original-title="{$lenguaje.str_buscar}" placeholder="{$lenguaje.str_buscar}" name="text_busqueda" id="text_busqueda" onkeypress="tecla_enter_foro(event)" value="{$palabrabuscada|default:''}">                  
                    <span class="input-group-btn">
                        <button class="btn  btn-success btn-buscador" for_funcion ="workshop" ajax="lista_buscar_workshop" type="button" id="buscar_foro"><i class="glyphicon glyphicon-search"></i></button>
                    </span>
                </div><!-- /input-group -->
        </div>
