     ...
     <div class="col col-xs-11 col-sm-11 col-md-11 col-lg-11">
          ...
          <div class="col col-xs-1 col-sm-1 col-md-1 col-lg-1   pull-right text-right titulo">
            ...
            <ul class="dropdown-menu" style="min-width: 200px;">
                ...
                <li><a href="{$_layoutParams.root}/foro/admin/form/new/workshop" class="opciones_foro" style="cursor: pointer;">Nuevo Workshop<i class="i_opciones_foro glyphicon glyphicon-plus pull-right"></i></a></li>
                {/if}
