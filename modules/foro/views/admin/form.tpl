<div  class="container" >   
    ...
    <h3 class="titulo-view">{$titulo}</h3>
    ...
    {/if}
    {if $permiso == "nuevo_foro"}
    <div class="row">
        <form method="post" >
            <div class="col-md-8">
                <div style="margin-bottom: 25px;" class="form-group" >
                    <label style="width: 8% !important; " class="col-lg-2 control-label">{$lenguaje.label_idioma}: </label>
                    {if  isset($idiomas) && count($idiomas)}              
                        <div class="form-inline col-lg-10">
                            {foreach from=$idiomas item=idi}
                                    {if  isset($datos) && count($datos)}
                                    {if $datos.Idi_IdIdioma==$idi.Idi_IdIdioma} <input type="hidden" value="{$idi.Idi_Idioma}" id="idiomaRadio" name="idiomaRadio"> 
                                    {/if}
                                <div class="radio">
                                    <label>
