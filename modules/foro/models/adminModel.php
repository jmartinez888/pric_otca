...
class adminModel extends Model {
    ...
    public function insertarForo($iFor_Titulo, $iFor_Objetivo, $iFor_ResultadosEsperados, $iFor_Palabras, $iFor_FechaCreacion,$iFor_FechaCierre,$iFor_Tipo, $iFor_Estado, $iLit_IdLineaTematica, $iUsu_IdUsuario,$iEnt_IdEntidad,$iRec_IdRecurso,$iIdi_IdIdioma) {
        try {
            ...
            $result->bindParam(7, $iFor_Tipo, PDO::PARAM_INT);
            $result->bindParam(8, $iFor_Estado, PDO::PARAM_INT);
            $result->bindParam(9, $iLit_IdLineaTematica, PDO::PARAM_INT);
            $result->bindParam(10, $iUsu_IdUsuario, PDO::PARAM_INT);
            $result->bindParam(11, $iEnt_IdEntidad, PDO::PARAM_INT);
             $result->bindParam(12, $iRec_IdRecurso, PDO::PARAM_INT);
            $result->bindParam(13, $iIdi_IdIdioma, PDO::PARAM_STR);
