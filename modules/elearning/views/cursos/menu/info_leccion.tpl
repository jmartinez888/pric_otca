      <div class="col-lg-12" id="panel-titulo-leccion">  
      <div class="panel panel-default margin-top-10">
        <div class="panel-heading">
          <ul class="nav nav-tabs">
              {if strlen($leccion["Lec_Descripcion"]) > 0 }
  <li class="active"><a data-toggle="tab" href="#inf_curso">Informacion de la Lección</a></li>
 {/if}
 ...
 {if isset($referencias) && count($referencias) > 0 }
  <li><a data-toggle="tab" href="#ref_mat">Referéncias</a></li>
  {/if}
</ul>
        </div>
        {if strlen($leccion["Lec_Descripcion"]) > 0 }
