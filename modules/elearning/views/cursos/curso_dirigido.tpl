          ...
          <div class="col-lg-12" style="padding-left: 0px !important">
            ...
            <div class="col-lg-12">
              <div class="ficha-mod col-lg-12">
                <div class="col-lg-2 ficha-mod-icon"><span class="glyphicon glyphicon-th"/></div>
                <div class="col-lg-10 ficha-mod-title">{$o.Mod_Titulo}</div>
                <div class="col-lg-10 ficha-mod-desc">{substr($o.Mod_Descripcion, 0, 200)}...</div>
              </div>
            </div>
              {foreach from=$o.LECCIONES item=l}
                <div class="col-lg-12">
                  <div class="ficha-leccion {if $l.Activo==1}lec-lms-activo{/if}">
                    <strong>{$l.Lec_Titulo}</strong><br/>
