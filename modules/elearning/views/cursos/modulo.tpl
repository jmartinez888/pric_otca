                                    ...
                                    {if $rl.Pre_Tipo==1}
                                        ...
                                        <div class="col-xs-12 margin-t-10 ">
                                          <div class="col col-xs-1">
                                            <input type="radio" value="{$ra.Alt_IdAlternativa}" required="" onclick="selectRadioClick('rpta_alt{$i-1}_{$j}');" class="col col-xs-6 radioalt" name="rpta_alt{$i-1}" id="rpta_alt{$i-1}_{$j}" />
                                            {if $j == 1}
