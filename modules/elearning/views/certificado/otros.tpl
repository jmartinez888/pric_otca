     ...
     <div class="panel-body" style=" margin: 15px">
             <div class="row" style="text-align:right">
                <div style="display:inline-block;padding-right:2em">
                    <input class="form-control" placeholder="Código" style="width: 150px; float: left; margin: 0px 10px;" name="palabracertificado" id="palabracertificado">
                    <button class="btn btn-success" style=" float: left" type="button" id="buscarcertificadootros"  ><i class="glyphicon glyphicon-search"></i></button>
                </div>
            </div>
