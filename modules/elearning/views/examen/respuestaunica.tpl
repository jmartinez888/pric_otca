        ...
        <form class="form-horizontal" autocomplete="on" method="POST">
            ...
            <div id="alt" style="margin-top:10px;">
              ...
              <div class="col col-sm-12" style="margin-top: 15px">
                ...
                <div class="col-sm-2">
                 <a data-toggle="tooltip" data-placement="bottom" title="Agregar alternativa"  class="btn btn-primary pull-right margin-top-10 glyphicon glyphicon-plus" id="btn_añadir1"></a>
               </div>
            </div>
        </form>
        </div>
