        ...
        <div class="table-responsive" style="width: 100%">
            <table class="table" id="tblMisCursos">
                ...
                {foreach from=$cursos item=c}
                    <tr >
                        <td>
                          <div class="col-xs-2" style="border-right: 1px solid #c1bcbc; "><img class="img-banner ma-w-100 " style="border: 1px solid #c1bcbc;" src="{BASE_URL}files/elearning/cursos/img/portada/{$curso.Cur_UrlBanner}" />
