    ...
    <div class="col-xs-12 panel-body" >
      <div class="col col-lg-12">
        ...
        <form id="form-buscar" action="gcurso/_view_mis_cursos" type="post">
          <div class="col-sm-offset-3 col-sm-4"><input name="busqueda" class="form-control" placeholder="{$lenguaje.str_buscar1}" name="text_busqueda" id="text_busqueda" onkeypress="tecla_enter_foro(event)" value="{$palabrabuscada|default:''}"/></div>
