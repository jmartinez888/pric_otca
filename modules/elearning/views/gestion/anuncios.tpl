...
<div class="col col-xs-12" >
    ...
    <div class="panel panel-default">
        <div class="panel-heading collapsed">
            <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed"><i style="float:right" class="f    glyphicon glyphicon-option-vertical"></i><i class="glyphicon glyphicon-bullhorn"></i>&nbsp;&nbsp;<strong>Nuevo Anuncio</strong></h3>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table" style="  margin: 20px auto">
                            ...
                            {if $tipo==0}
                                ...
                                {else}
                                <tr>
                                    <td style=" text-align: center"> <a data-book-id="{$rl.Anc_Titulo}" data-book-texto="{$rl.Anc_Descripcion}" data-toggle="modal"  data-target="#confirm-leer" title="{$lenguaje.label_eliminar}" data-book-id-anuncio="{$rl.Anc_IdAnuncioCurso}" data-book-id-curso="{$rl.Cur_IdCurso}" data-placement="bottom" > {if $rl.Anu_Leido==0}<b>{/if}{$numeropagina++}{if $rl.Anu_Leido==0}</b>{/if}</a></td>
                                    <td style=" text-align: center"> <a data-book-id="{$rl.Anc_Titulo}" data-book-texto="{$rl.Anc_Descripcion}" data-toggle="modal"  data-target="#confirm-leer" title="{$lenguaje.label_eliminar}" data-book-id-anuncio="{$rl.Anc_IdAnuncioCurso}" data-book-id-curso="{$rl.Cur_IdCurso}" data-placement="bottom" > {if $rl.Anu_Leido==0}<b>{/if}{$rl.Anc_Titulo}{if $rl.Anu_Leido==0}</b>{/if}</a></td>
                                    <td style=" text-align: center"> <a data-book-id="{$rl.Anc_Titulo}" data-book-texto="{$rl.Anc_Descripcion}" data-toggle="modal"  data-target="#confirm-leer" title="{$lenguaje.label_eliminar}" data-book-id-anuncio="{$rl.Anc_IdAnuncioCurso}" data-book-id-curso="{$rl.Cur_IdCurso}" data-placement="bottom" > {if $rl.Anu_Leido==0}<b>{/if}{$rl.Anc_DescripcionRec}...{if $rl.Anu_Leido==0}</b>{/if}</a></td>
                                    <td style=" text-align: center"> <a data-book-id="{$rl.Anc_Titulo}" data-book-texto="{$rl.Anc_Descripcion}" data-toggle="modal"  data-target="#confirm-leer" title="{$lenguaje.label_eliminar}" data-book-id-anuncio="{$rl.Anc_IdAnuncioCurso}" data-book-id-curso="{$rl.Cur_IdCurso}" data-placement="bottom" > {if $rl.Anu_Leido==0}<b>{/if}{$rl.Anc_FechaReg}{if $rl.Anu_Leido==0}</b>{/if}</a></td>
                                    </tr>
                                {/if}
                            {/foreach}
                        </table>
