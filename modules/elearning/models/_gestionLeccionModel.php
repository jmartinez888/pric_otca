...
class _gestionLeccionModel extends Model {
  ...
  public function insertLeccion($modulo, $tipo, $titulo, $descripcion, $dedicacion){
    $sql = "INSERT INTO leccion(Moc_IdModuloCurso, Lec_Tipo, Lec_Titulo, Lec_Descripcion, Lec_TiempoDedicacion, Lec_LMSEstado, Lec_Estado) VALUES(NULL, {$tipo}, '{$titulo}', '{$descripcion}', '{$dedicacion}', 0, 1);
    ";
