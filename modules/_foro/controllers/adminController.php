...
class adminController extends foroController {
    ...
    public function form($tipo, $id_foro = 0) {
        ...
        if ($this->botonPress("bt_guardar")) {
            ...
            $iFor_FechaCierre = $this->getTexto('text_date');
            ...
            $result_foro = $this->_model->insertarForo($iFor_Titulo, $iFor_Objetivo, $iFor_ResultadosEsperados, $iFor_Palabras, $iFor_FechaCierre, $iFor_Tipo, $iFor_Estado, $iLit_IdLineaTematica, $iUsu_IdUsuario, $iEnt_IdEntidad,$result_rec[0], $iIdi_IdIdioma);
        ...
        $this->_view->setJs(array('form', array(BASE_URL . 'public/ckeditor/ckeditor.js'), array(BASE_URL . 'public/ckeditor/adapters/jquery.js')));
