...
$(document).on('ready', function () {   
    ...
    var paginacion = function (pagina, nombrelista, datos,total_registros) {
        ...
        $.post(_root_ + 'oferta/ofertasacademicas/_paginacion_' + nombrelista + '/' + datos, pagina, function (data) {
            $("#" + nombrelista).html('');
            $("#cargando").hide();
...
function buscarPalabraDocumentos(palabra) { 
    ...
    document.location.href = _root_ + 'oferta/OfertasAcademicas/buscarporpalabras/' + palabra
