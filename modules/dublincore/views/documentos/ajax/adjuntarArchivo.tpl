                        ...
                        <form data-toggle="validator" class="form-horizontal" role="form" enctype="multipart/form-data" method="post" id="registrardublin">
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-4 col-md-6">
                                    <button type="button" id="btn_registrar_archivo" name="btn_registrar_archivo" class="btn btn-primary">Registrar</button>
                                    <input type="hidden" value="1" name="registrar" id="registrar"/>
                                    <input type="hidden" value="{$recurso.Rec_IdRecurso}" name="Rec_IdRecurso" id="Rec_IdRecurso"/>
                                </div>
                            </div>
                        </form>
                    </div> 
