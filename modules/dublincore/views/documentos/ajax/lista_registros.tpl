                ...
                {if isset($totaltipoarchivofisicos) && count($totaltipoarchivofisicos)}
                    {foreach item=datos from=$totaltipoarchivofisicos}    
                        <div style="width: 100%; width:12%; float: left" align="center">
                            <img class="pais " style="cursor:pointer" src="{$_layoutParams.root_clear}public/img/legal/{$datos.Pai_Nombre}.png" 
                        ...
                        {foreach item=datos from=$documentos}
                            <div class="cajita">
                                <div class="primero">
                                    ...
                                    <img class="pais " style="cursor:pointer" src="{$_layoutParams.root_clear}public/img/documentos/{$datos.Taf_Descripcion}.png" pais="{$datos.Taf_Descripcion}" title="Listar {$datos.Taf_Descripcion}"/>
                                ...
                                <div >
                                    ...
                                    <a href="{$_layoutParams.root_clear_archivo_fisico}{$datos.Arf_PosicionFisica}" target="_blank"><span class="ha" style="cursor:pointer" title="Descargar {$datos.Taf_Descripcion}"> Descargar </span></a>
                                </div>
                            </div>
                                <br><br>
                        {/foreach}
