<script id="js_OrigenesDeVisitas" type="text/javascript"></script>
    ...
    <div class="panel panel-default">
        <div class="panel-heading jsoftCollap">
            <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed">
                <i class="glyphicon glyphicon-equalizer"></i>&nbsp;&nbsp;<strong>{$lenguaje.estadisticas_grafico_origenes}</strong><i style="float:right" class="glyphicon glyphicon-option-vertical"></i>
                <input type="hidden" id="titulo4" value=" {$lenguaje.est_label_titulo_grafico4}" />
            </h3>
        </div>
        <div style="height: 0px;" aria-expanded="false" id="collapse3" class="panel-collapse collapse">
            <div class="panel-body">
                <div id="grafica" style="min-width: 310px; height: 400px; margin: 0 auto">
                    ...
                    <div id="c_OrigenesDeVisitas" style="margin: 20px auto"></div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                     <i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;<strong>{$lenguaje.estadisticas_buscar_origenes}</strong>
                </h3>
            </div>
...
<br />
                    ...
                    <br>
                <h4><b>{$lenguaje.estadisticas_buscar_origenes_tabla_titulo}</b></h4>
