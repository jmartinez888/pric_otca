...
<div class="row" id="index_banner">
  ...
  <div class="col-lg-12">
    <div class="row">
      ...
      <div class="col-sm-6 col-lg-6">
        <a type="button" href="{$_layoutParams.root}difusion/indicadores/create" class="btn btn-success  pull-right" style="margin-right: 15px;" title="{$lenguaje['str_nuevo']}">{$lenguaje['str_nuevo']}</a>
      </div>
    </div>
  ...
  <div class="col-sm-12" style="margin-top: 8px">
        <div class="row">
            <div v-for="item in indicadores" class="col-sm-4 col-md4- pb-4 pt-4"  :id="'container-indicador-' + item.id">
