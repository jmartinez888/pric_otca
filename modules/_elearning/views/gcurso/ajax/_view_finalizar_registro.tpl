...
<div class="col-lg-12">
  <button class="btn btn-success" style=" float: left" type="button" id="btn_regresar">
    <i class="glyphicon glyphicon-book"></i> Regresar
  </button>
</div>
<input class="estado" id="hiddenIdCurso" value="{$curso.Cur_IdCurso}" />
