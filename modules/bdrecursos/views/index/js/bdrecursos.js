...
//                $("#correo").val(),$("#usuario").val(),$("#contrasena").val(),$("#confirmarContrasena").val());
    ...
    $("body").on('click', "#sl_recurso", function() {
        ...
        _Rec_IdRecurso = $("#sl_recurso").val();
        if (_Rec_IdRecurso === undefined) {
            _Rec_IdRecurso = "";
        }

        _post = $.post(_root_ + 'bdrecursos/index/_registrar_importar_datos',
                {
                    _Rec_IdRecurso_: _Rec_IdRecurso
                },
        function(data) {
            $("#cargando").hide();
            $("#registrar_importar_datos").html('');
            $("#registrar_importar_datos").html(data);
        });
    });
