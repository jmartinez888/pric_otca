        ...
        <div class="col-md-12">
          <div class="panel panel-default">          	
            <div class="panel-heading">
              <label>Total de Registros:</label> {$total_registros} |
              <label>Total Registrados:</label> {$total_registrado} |
              <label>Total No Registrados:</label> {$total_no_registrado} 
            <span class="badge  pull-right"><a href="{$_layoutParams.root}bdrecursos/import/descargar_datos" target="_blank" title="Descargar Data"><i class="glyphicon glyphicon-download" ></i></a></span>
            </div>
            {$i=0}
            <div class="table-responsive">
              {if count($no_registrado)>0}
