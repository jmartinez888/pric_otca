...
<div style="width: 100%; margin: 0px auto">
    ...
    <form class="form-horizontal" role="form" method="post" action="" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <p><input  class="form-control" id="usuario" type="text" name="usuario" value="{$datos.usuario|default:""}" placeholder="Usuario"/></p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <p><input class="form-control" id="contrasena" type="password" name="contrasena" placeholder="Contraseña"/></p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                <p><input class="form-control" id="confirmarContrasena" type="password" name="confirmarContrasena" placeholder="Confirmar"/></p>
            </div>
        </div>
        
        <div class="form-group">
            <div class="col-lg-offset-2 col-lg-10">
            <button class="btn btn-primary" type="button" id="guardarUsuario" ><i class="icon-plus-sign icon-white"> </i>Registrar</button>
            </div>
        </div>
    </form>
</div>
