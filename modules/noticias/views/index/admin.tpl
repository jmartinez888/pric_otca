    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed">
                <i style="float:right" class="glyphicon glyphicon-option-vertical"></i><i class="glyphicon glyphicon-plus-sign"></i>&nbsp;&nbsp;<strong>Nueva Noticia</strong>
            </h3>
        </div>
                ...
                <div id="nueva_arquitectura_hijo" style=" margin: 15px auto" >
                    <form class=" form-horizontal " data-toggle="validator" id="form2" name="form2" role="form" method="post" action="" autocomplete="on">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control" id ="nombre" type="text" name="nombre"  placeholder="Título de Noticia" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label" >{$lenguaje.label_descripcion} : </label>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" >{$lenguaje.label_tipo} : </label>
                            <div class="col-lg-10">
                                <select class="form-control" id="tipoNoticia" name="tipoNoticia" style=" float: left; margin: 0px 4px 0px 4px" required>
                                    <option value="">{$lenguaje.select_option_seleccione}</option>
                                    {if $tipos_noticia}
                                        {foreach from=$tipos_noticia item=tn}
                                        <option value="{$tn.Tin_IdTipoNoticia}">{$tn.Tin_Nombre}</option>
                                        {/foreach}
                                    {else}
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label" >{$lenguaje.label_url} : </label>
                            <div class="col-lg-10">
                                <input class="form-control" id="url" type="text" name="url" placeholder="{$lenguaje.label_url}" required="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-2 control-label" >{$lenguaje.label_posicion} : </label>
