...
class importModel extends Model
{
    ...
    {
        $this->_db->query("UPDATE archivo_fisico SET Taf_IdTipoArchivoFisico = $formato, Arf_URL = '$url' WHERE Arf_IdArchivoFisico = $idarchivo ");       
    }
    ...
    public function registrarArchivoFisico($ArchivoFisico,$Taf_IdTipoArchivoFisico,$Arf_FechaCreacion)
    {
        $this->_db->prepare(
                "insert into archivo_fisico (Arf_PosicionFisica,Taf_IdTipoArchivoFisico,Arf_FechaCreacion,Arf_Estado) values " .
                "(:Arf_PosicionFisica,:Taf_IdTipoArchivoFisico,:Arf_FechaCreacion,1)"
                )
                ->execute(array(
    ...
    public function registrarUrlArchivoFisico($Arf_URL,$Taf_IdTipoArchivoFisico,$Arf_FechaCreacion)
    {
        $this->_db->prepare(
                "insert into archivo_fisico (Arf_URL,Taf_IdTipoArchivoFisico,Arf_FechaCreacion,Arf_Estado) values " .
                "(:Arf_URL,:Taf_IdTipoArchivoFisico,:Arf_FechaCreacion,1)"
                )
                ->execute(array(
                    ':Arf_URL' => $Arf_URL,
                    ':Taf_IdTipoArchivoFisico' => $Taf_IdTipoArchivoFisico,
    ...
    {
        $this->_db->prepare(
                "insert into tema_dublin (Ted_Descripcion,Ted_Estado,Idi_IdIdioma) values " .
                "(:Ted_Descripcion,1,:Idi_IdIdioma)"
                )
                ->execute(array(
    ...
    {
        $this->_db->prepare(
                "insert into tipo_dublin (Tid_Descripcion, Tid_Estado, Idi_IdIdioma) values " .
                "(:Tid_Descripcion, 1, :Idi_IdIdioma)"
                )
                ->execute(array(
    ...
    public function registrarDublinCore($Dub_Titulo, $Dub_Descripcion, $Dub_Editor, $Dub_Colabrorador, $Dub_FechaDocumento, $Dub_Formato, $Dub_Identificador, $Dub_Fuente, $Dub_Idioma, $Dub_Relacion, $Dub_Cobertura, $Dub_Derechos, $Dub_PalabraClave, $Tid_IdTipoDublin, $Rec_IdRecurso, $Idi_IdIdioma, $Arf_IdArchivoFisico,$Ted_IdTemaDublin)
    {
        ...
        $this->_db->prepare(
                "insert into dublincore (Dub_Titulo, Dub_Descripcion, Dub_Editor, Dub_Colaborador, Dub_FechaDocumento, Dub_Formato, Dub_Identificador, Dub_Fuente, Dub_Idioma, Dub_Relacion, Dub_Cobertura, Dub_Derechos, Dub_PalabraClave, Tid_IdTipoDublin, Rec_IdRecurso,Idi_IdIdioma,Arf_IdArchivoFisico,Ted_IdTemaDublin, Dub_Estado, Usu_IdUsuario) values " .
                "(:Dub_Titulo, :Dub_Descripcion, :Dub_Editor, :Dub_Colaborador, :Dub_FechaDocumento, :Dub_Formato, :Dub_Identificador, :Dub_Fuente, :Dub_Idioma, :Dub_Relacion, :Dub_Cobertura, :Dub_Derechos, :Dub_PalabraClave, :Tid_IdTipoDublin, :Rec_IdRecurso,:Idi_IdIdioma,:Arf_IdArchivoFisico,:Ted_IdTemaDublin, 1, ".$Usu_IdUsuario.")"
                )
                ->execute(array(
