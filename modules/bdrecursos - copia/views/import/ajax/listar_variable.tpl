<form action="../registrardata/{$id_recurso}/excel" method="post" autocomplete="on" data-toggle="validator" class="form-horizontal" role="form" id="lista_estandar">
<table class="table">
  <thead>
    <tr>
...
<center>
  <button type="submit" id="btnEnviar" name="btnEnviar" class="btn btn-success">Registrar Datos</button>
</center>
</form>
