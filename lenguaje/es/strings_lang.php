<?php
	$lenguaje["str_eliminar"] = "Eliminar";
	$lenguaje["str_editar"] = "Editar";
	...
	$lenguaje['str_cargar_imagen'] = 'Cargar imagen';
	...
	$lenguaje['str_registro_b_success'] = 'Elemento creado con éxito';
