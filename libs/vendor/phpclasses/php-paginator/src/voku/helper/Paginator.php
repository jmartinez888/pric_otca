...
class Paginator
{
   ...
   * @var string
   */
  private $_paginatorStartChar = '<i class="fa fa-angle-left"></i>';

  /**
   * @var string
   */
  private $_paginatorEndChar = '<i class="fa fa-angle-right"></i>';
  ...
  private function createLiCurrentOrNot(string $path, int $counter): string
  {
    ...
    if ($counter == $this->_pageIdentifierFromGet) {
      ...
      $html .= '<li class="current active"><span>' . $currentTextAndOrLink . '</span></li>';
    } else {
  ...
  public function page_links(string $path = '?'): string
  {
    ...
    if ($lastpage > 1) {
      ...
      if ($this->_pageIdentifierFromGet > 1) {
        ...
        $pagination .= '<li class="' . $this->_paginatorStartCssClass . ' disabled"><a href="javascript:void(false)"><span>' . $this->_paginatorStartChar . '</span></a></li>';
      }
      ...
      if ($lastpage < 7 + ($this->_adjacent * 2)) {
        ...
        $pagination .= '<li><a href="#" onclick="return false;"><span>&hellip;</span></a></li>';
      ...
      if ($this->_pageIdentifierFromGet < $counter - 1) {
        ...
        $pagination .= '<li class="' . $this->_paginatorEndCssClass . ' disabled"><a href="javascript:void()"><span>' . $this->_paginatorEndChar . '</span></a></li>';
      }

      $pagination .= '</ul>';
    } else {

      $pagination = '<ul class="pagination"><li class="' . $this->_paginatorStartCssClass . ' disabled"><a href="javascript:void(false)"><span>' . $this->_paginatorStartChar . '</span></a></li><li class="current active"><span>1</span></li><li class="' . $this->_paginatorEndCssClass . ' disabled"><a href="javascript:void()"><span>' . $this->_paginatorEndChar . '</span></a></li></ul>';
    }
